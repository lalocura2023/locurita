...
class Themes {
  ...
  static ThemeData _baseTheme(ThemeData themeData) {
    ...
    Color scaffoldBackgroundColor = isDark ? Color(0xFF101518) : Color(0xFFF4F8FB);
    ...
    Color focusedErrorBorderColor = isDark ? Color(0xFFE20000) : Color(0xFF5C00E4);

    IconThemeData primaryIconTheme = IconThemeData(color: isDark ? Colors.white : Colors.black);

    Color textColor = isDark ? Colors.grey[100] : Colors.black;

    TextTheme textTheme = themeData.textTheme.apply(displayColor: isDark ? Colors.grey[200] : Colors.black, fontFamily: 'Nunito');
    ...
    return themeData.copyWith(
      ...
      appBarTheme: AppBarTheme(
          ...
          textTheme: textTheme.copyWith(headline6: textTheme.headline6.copyWith(fontSize: 20, color: textColor))),
      ...
      textTheme: textTheme.copyWith(
        bodyText1: textTheme.bodyText1.copyWith(fontWeight: FontWeight.normal, fontSize: 15),
        bodyText2: textTheme.bodyText2.copyWith(),
        button: textTheme.button.copyWith(fontWeight: FontWeight.bold, fontSize: 15),
        caption: textTheme.caption.copyWith(),
        headline1: textTheme.headline1.copyWith(fontWeight: FontWeight.bold, color: textColor),
        headline2: textTheme.headline2.copyWith(fontWeight: FontWeight.bold, color: textColor),
        headline3: textTheme.headline3.copyWith(fontWeight: FontWeight.bold, color: textColor),
        headline4: textTheme.headline4.copyWith(fontWeight: FontWeight.bold, color: textColor),
        headline5: textTheme.headline5.copyWith(fontWeight: FontWeight.bold, color: textColor),
        headline6: textTheme.headline6.copyWith(fontWeight: FontWeight.bold, color: textColor),
      ),
      inputDecorationTheme: InputDecorationTheme(
          ...
          enabledBorder: OutlineInputBorder(borderSide: BorderSide(color: enabledBorderColor, width: 1.5), borderRadius: borderRadius),
          focusedBorder: OutlineInputBorder(borderSide: BorderSide(color: focusedBorderColor, width: 1.5), borderRadius: borderRadius),
          errorBorder: OutlineInputBorder(borderSide: BorderSide(color: errorBorderColor, width: 1.5), borderRadius: borderRadius),
          focusedErrorBorder: OutlineInputBorder(borderSide: BorderSide(color: focusedErrorBorderColor, width: 1.5), borderRadius: borderRadius),
          disabledBorder: OutlineInputBorder(borderSide: BorderSide(color: disabledBorderColor, width: 1.5), borderRadius: borderRadius),
          isDense: true),
    );
  }
